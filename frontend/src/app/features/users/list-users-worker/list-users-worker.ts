...
@Component({
  selector: 'app-list-users-worker',
  standalone: false,
  templateUrl: './list-users-worker.html',
  styleUrl: './list-users-worker.scss'
})
export class ListUsersWorkerComponent implements OnInit {
  usuarios: Usuario[] = [];
