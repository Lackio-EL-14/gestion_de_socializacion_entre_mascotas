...
@Component({
	selector: 'app-see-publications-owner',
	standalone: false,
	templateUrl: './see-publications-owner.html',
	styleUrl: './see-publications-owner.scss',
})
export class SeePublicationsOwner implements OnInit {
